...
[Exercise 1-16](./%40BrianWKernighanProgrammingLanguage1988/chapter_1/1-16_longest-line_revise.c). Revise the main routine of the longest-line program so it will
correctly print the length of arbitrarily long input lines, and as much as
possible

[Exercise 1-17](./%40BrianWKernighanProgrammingLanguage1988/chapter_1/1-17_lines_longest_than_80_characters.c). Write a program to print all input lines that are longer than 80
characters.
