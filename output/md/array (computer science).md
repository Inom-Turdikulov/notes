...
==allocate some [memory](./computer%20memory.md)== to store array, during its
initialization.
<!--SR:!2023-07-21,2,236-->
...
new value into ordered array. But with [binary search](/not_created.md) we can insert elements
more effectively.
<!--SR:!2023-07-20,1,216-->

Main advantage of ordered array is that we can use ==[binary search](/not_created.md)== algorithm
