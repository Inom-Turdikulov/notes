...
Checksums are verified, check this section [win_setup_script](./win_setup_script.md)
...
To download, I use this URL: <[https://geo.mirror.pkgbuild.com/iso/latest/>](https://geo.mirror.pkgbuild.com/iso/latest/>)
